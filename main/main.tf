...
module "vpc" {
  ...
  var_hub_pan_subnet    = "${var.hub_pan_subnet}"
  var_hub_spoke1_mysql_subnet= "${var.hub_spoke1_mysql_subnet}"
...
module "hub" {
  ...
  company               = "${var.var_company}"
  var_hub_pan_subnet = "${var.hub_pan_subnet}"
  var_hub_spoke1_mysql_subnet= "${var.var_hub_spoke1_mysql_subnet}"
}
